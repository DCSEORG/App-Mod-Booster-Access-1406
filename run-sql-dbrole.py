#!/usr/bin/env python3
"""Execute DB role SQL script on Azure SQL Database using Azure Active Directory authentication"""
import pyodbc
import struct
import os
from azure.identity import AzureCliCredential

SERVER = os.environ.get("SQL_SERVER_FQDN", "$(SQL_SERVER_FQDN)")  # Set from deployment output
DATABASE = "Northwind"
