...
# ============================================================
# Northwind App - Azure Deployment Script (with GenAI)
...
echo "============================================================"
echo " Northwind App - Azure Deployment (with GenAI)"
echo "============================================================"
...
# 2. Deploy Bicep with GenAI
echo ""
echo "Step 2: Deploying Azure infrastructure with GenAI (Bicep)..."
...
echo "  ✓ Base App Service settings configured"

# Set OpenAI settings after deployment (post-deploy to avoid circular dependency)
...
if [ -n "$OPENAI_ENDPOINT" ]; then
  az webapp config appsettings set \
    ...
    --output none
  echo "  ✓ OpenAI settings configured"
fi
...
echo " Chat UI:     https://$APP_HOSTNAME/Chat"
